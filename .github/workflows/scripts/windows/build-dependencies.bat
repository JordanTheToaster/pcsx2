...
call :downloadfile "harfbuzz-%HARFBUZZ%.zip" https://github.com/harfbuzz/harfbuzz/archive/refs/tags/%HARFBUZZ%.zip 8f90735337434ed3ed30e97f82f39799575cd79aa5ff841caab7971b3369d3c9 || goto error
