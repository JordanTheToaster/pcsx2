...
static array<MemoryDomainProxy ^> ^ GetInterfaces() {
    ...
    array<MemoryDomainProxy ^> ^ interfaces = gcnew array<MemoryDomainProxy ^>(7);
    interfaces[0] = gcnew MemoryDomainProxy(gcnew EERAM);
    interfaces[1] = gcnew MemoryDomainProxy(gcnew VURAM);
    interfaces[2] = gcnew MemoryDomainProxy(gcnew IOPRAM);
    interfaces[3] = gcnew MemoryDomainProxy(gcnew KernelMemory);
    interfaces[4] = gcnew MemoryDomainProxy(gcnew Scratchpad);
    interfaces[5] = gcnew MemoryDomainProxy(gcnew GSRAM);
    interfaces[6] = gcnew MemoryDomainProxy(gcnew SPU2RAM);
    //interfaces[7] = gcnew MemoryDomainProxy(gcnew IORegs);
    //interfaces[8] = gcnew MemoryDomainProxy(gcnew SPU2Regs);
